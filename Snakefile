...
rule pf_for_lossy_network: 
    ...
    output: nc="results/networks/elec_s_{clusters}_ec_l{ll}_{opts}_L{loss}_S{slack}.nc",
...
rule pf_for_lossless_network: 
    ...
    output: nc="results/networks/elec_s_{clusters}_ec_l{ll}_{opts}_S{slack}.nc",
